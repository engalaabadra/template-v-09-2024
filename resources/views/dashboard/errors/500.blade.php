...
<head>
    <base href="">
    <meta charset="utf-8"/>
    <title>{{__('admin/dashboard.error_title')}}</title>
...
<div class="d-flex flex-column flex-root">
    <div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center"
        ...
        <div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-12">
            ...
            <p style="font-size: 23px">Looks like something went wrong.We're working on it go to <a href="{{url('admin/home')}}" class="btn btn-outline-success">Home</a>
            </p>
        </div>
    </div>
</div>
